...
一个专注于 Agentic AI 研究的学术论文收集、翻译和管理平台，基于 Claude Agent SDK 和 MCP Skills 构建，为中文读者提供高质量的人工智能智能体领域技术资源。
...
- [📖 系统架构](docs/01-framework.md) - 架构设计和技术栈
- [💻 开发指南](docs/02-development.md) - 开发环境和代码规范
- [👥 用户手册](docs/03-user-guide.md) - 安装部署和使用教程
- [🧪 测试方案](docs/04-testing.md) - 测试框架和 CI/CD
- [🚀 GitHub Actions](docs/05-github-actions.md) - 自动化工作流
...
系统采用混合架构，结合 **Claude Agent SDK** 标准化接口与 **MCP Skills** 专用能力，提供模块化、可扩展的论文处理解决方案。
